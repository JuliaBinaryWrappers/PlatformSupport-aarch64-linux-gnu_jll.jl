module PlatformSupport-aarch64-linux-gnu_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PlatformSupport-aarch64-linux-gnu_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("2e6c119e-b0ec-5d92-8875-ba22d7cafac5"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PlatformSupport-aarch64-linux-gnu", artifacts_toml) for e in artifacts["PlatformSupport-aarch64-linux-gnu"]]
...
if best_platform === nothing
    @debug("Unable to load PlatformSupport-aarch64-linux-gnu; unsupported platform $(triplet(platform_key_abi()))")
else
    # Load the appropriate wrapper
    include(joinpath(@__DIR__, "wrappers", "$(best_platform).jl"))
end

end  # module PlatformSupport-aarch64-linux-gnu_jll
